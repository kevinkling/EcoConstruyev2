...
const requests: DonationRequest[] = [
  ...
  },
  {
    ...
    message: "Ladrillos para proyecto de mejoramiento habitacional en La Matanza",
    status: "aprobada",
  ...
  },
  {
    ...
    message: "Cerámicos para finalizar obra de centro comunitario",
    status: "completada",
    requestDate: "2024-01-10",
    responseDate: "2024-01-12",
    pickupDate: "2024-01-18",
    volunteerAssigned: "voluntario1",
  },
  {
    id: "4",
    materialId: "1",
    ongId: "ong3",
    ongName: "Un Techo Para Mi País",
    requestedQuantity: 30,
    message: "Cemento urgente para reparación de escuela rural en San Miguel",
    status: "aprobada",
  ...
  },
  {
    ...
    materialId: "2",
    ongId: "ong4",
    ongName: "Construyendo Futuro",
    requestedQuantity: 200,
    message: "Ladrillos para construcción de guardería infantil en Quilmes",
    status: "pendiente",
  ...
  },
  {
    ...
    message: "Arena para nivelación de terreno en proyecto habitacional",
    status: "rechazada",
  ...
  },
  {
    ...
    materialId: "5",
    ongId: "ong5",
    ongName: "Manos Solidarias",
    requestedQuantity: 8,
    message: "Chapa ondulada para techado de comedor comunitario en Tigre",
    status: "aprobada",
  ...
  },
  {
    ...
    message: "Hierro del 8 para estructura de techo en vivienda de emergencia",
    status: "pendiente",
  ...
  },
  {
    ...
    materialId: "7",
    ongId: "ong6",
    ongName: "Construir Esperanza",
    requestedQuantity: 40,
    message: "Pintura para renovación de centro de día para adultos mayores",
    status: "completada",
    requestDate: "2024-01-12",
    responseDate: "2024-01-14",
    pickupDate: "2024-01-17",
    volunteerAssigned: "voluntario2",
  },
  {
    id: "10",
    materialId: "8",
    ...
    message: "Caños de PVC para instalación sanitaria en módulos habitacionales",
    status: "aprobada",
  ...
  },
  {
    ...
    message: "Cerámicos para sanitarios de centro educativo en construcción",
    status: "pendiente",
  ...
  },
  {
    ...
    materialId: "10",
    ongId: "ong7",
    ongName: "Hogar de Esperanza",
    requestedQuantity: 10,
    message: "Tanque de agua para mejora habitacional en hogar de niños",
    status: "aprobada",
